...
> Nota: a [faq-vendas.md:76](../docs/referencias/faq-vendas.md#L76) ainda lista só Pix/cartão para a assinatura. Vale atualizar a base de conhecimento para incluir boleto no mensal, senão a Clara pode se contradizer se o lead perguntar a forma de pagamento depois.
